...
import 'package:creator_side/home_module/components/post/detailed_post_screen.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            ...
            onTap: () {
              // TODO: Redirect to detailed post screen
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => DetailedPostScreen(
                            ...
                            commentCounter: widget.commentCounter,
                          )));
            },
          ...
          /// Likes, Comments, Share and circle avatars
          Row(
